...
./build/$PGO_HOST/llvm/bin/llvm-profdata \
    merge -o /tmp/combined.profdata /tmp/rustc-pgo.profdata /tmp/llvm-pgo.profdata
...
$@ \
    --rust-profile-use=/tmp/combined.profdata \
    --llvm-profile-use=/tmp/combined.profdata
